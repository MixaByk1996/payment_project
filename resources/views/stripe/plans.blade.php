                    ...
                    @foreach ($plansAll as $item)
                        <div class="pricing-item">
                            <div class="pricing-deco l-slategray">
                                ...
                                <div class="pricing-price"><span class="pricing-currency">$</span>{{ $item->price/100 }}
                            ...
                            <a href="{{ route('plans.checkout', $item->plan_id) }}" class="pricing-action l-amber">Choose plan</a>
                        </div>
                    @endforeach
